        ...
        <div className="lg:col-span-2">
          ...
          <div className="mt-8 bg-white dark:bg-gray-700 rounded-lg shadow-md p-6">
            ...
            <div className="space-y-6">
              {reviews.map((review) => (
                <div key={review.id} className="border-b border-gray-200 dark:border-gray-600 pb-6 last:border-0 last:pb-0">
          ...
          <div className="bg-white dark:bg-gray-700 rounded-lg shadow-md p-6 sticky top-8">
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-3 gap-2">
                {['10:00', '12:00', '14:00', '16:00', '18:00', '20:00'].map((time, index) => (
                  <button
                    key={index}
                    className="py-2 text-sm font-medium bg-gray-100 text-gray-700 hover:bg-gray-200 rounded-md dark:bg-gray-600 dark:text-gray-300 dark:hover:bg-gray-500"
                  >
                    {time}
                  </button>
                ))}
