...
var Leaderboard = function () {
    var _a = (0, react_1.useState)('all'), timeFilter = _a[0], setTimeFilter = _a[1];
    ...
    return (<div className="container mx-auto px-4 py-8">
      ...
      <div className="flex justify-center mb-8">
        <div className="inline-flex rounded-md shadow-sm" role="group">
          <button type="button" onClick={function () { return setTimeFilter('week'); }} className={"px-4 py-2 text-sm font-medium rounded-l-lg ".concat(timeFilter === 'week'
            ? 'bg-blue-600 text-white'
            : 'bg-white text-gray-700 hover:bg-gray-100 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600')}>
            კვირა
          </button>
          <button type="button" onClick={function () { return setTimeFilter('month'); }} className={"px-4 py-2 text-sm font-medium ".concat(timeFilter === 'month'
            ? 'bg-blue-600 text-white'
            : 'bg-white text-gray-700 hover:bg-gray-100 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600')}>
            თვე
          </button>
          <button type="button" onClick={function () { return setTimeFilter('all'); }} className={"px-4 py-2 text-sm font-medium rounded-r-lg ".concat(timeFilter === 'all'
            ? 'bg-blue-600 text-white'
            : 'bg-white text-gray-700 hover:bg-gray-100 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600')}>
            ყველა დრო
          </button>
      ...
      <div className="bg-white dark:bg-gray-700 rounded-lg shadow-md overflow-hidden">
        ...
        <div className="divide-y divide-gray-200 dark:divide-gray-600">
          {leaderboard.map(function (user) { return (<div key={user.id} className={"grid grid-cols-12 gap-4 px-6 py-4 ".concat(user.rank <= 3
                ? 'bg-blue-50 dark:bg-blue-900'
                : 'bg-white dark:bg-gray-700')}>
              <div className="col-span-1 flex items-center">
                <span className={"font-bold ".concat(user.rank === 1
